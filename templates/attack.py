...
atkExample = [
    ...
    skillCmd.createSkill(0, monsterName="Gorillaphant"), # commands below using this 'monsterName'
    skillCmd.createSkill(3),
    skillCmd.createSkill(1),
    skillCmd.createSkill(0),
    skillCmd.createSkill(2),
    skillCmd.createSkill(4),
    skillCmd.createSkill(0, monsterName="Seed Spitter"), # commands below using this 'monsterName'
    skillCmd.createSkill(3),
    skillCmd.createSkill(1),
    skillCmd.createSkill(0),
    skillCmd.createSkill(2),
